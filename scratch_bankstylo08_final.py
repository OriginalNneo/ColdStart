...
predictions/Task3_BankStylo08_Prediction.csv. No Kaggle submission here.
"""
import re, time
...
SEED = 42
t0 = time.time()
FRAC, ROUNDS, WS, ALPHA, BANK_S, STYLO_S = 0.5, 1, 1.6, 0.9, 0.02, 0.08
...
def main():
    ...
    out = "predictions/Task3_BankStylo08_Prediction.csv"
